...
/**
 * DTO used to create a physical service request.
 *
 * @author BaD-DeV
 * @since 1.0
 */
...
@Schema(
        name = "RequestPhysicalServiceCreateForm",
        description = "Payload used to create a physical service request"
)
public class RequestPhysicalServiceCreateForm extends PhysicalPostCreateForm {
